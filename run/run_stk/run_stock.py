...
from strategies.STK_Cta_Paral.Main_Cta import Main_Cta
from db.db_cfg import cfg_stk
from db.util_stk import combine_dsb_1m, resample, testBtSnooper, get_bao_stocks
...
def run_bt():
    ...
    for asset in assets:
        ...
        store_path_1m = f'{cfg_stk.WT_STORAGE_DIR}/his/min1/{exchange}/{code}.dsb'
        store_path_target = f'{cfg_stk.WT_STORAGE_DIR}/his/{period_dict[period]+str(n)}/{exchange}/{code}.dsb'
        try:
    ...
    engine.init(folder='../cfg_stk', cfgfile='./configbt.yaml')
