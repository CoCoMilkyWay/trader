...
from Parallel_pool import n_processor_queue
from Processor import n_Processor
from Glob_Ind import Glob_Ind
from Define import MetadataIn, MetadataOut, bt_config
    ...
    def on_calculate(self, context:CtaContext):
        ...
        for idx, code in enumerate(self.__codes__):
            ...
            try: # some asset may not have bar at xxx time
                ...
                continue
        # print(f'Healthy assets: {healthy_asset}/{len(self.__codes__)}')
