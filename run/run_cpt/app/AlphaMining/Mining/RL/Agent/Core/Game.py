...
#         """
#         frame = cv2.cvtColor(
#             frame, cv2.COLOR_RGB2BGR)  # Convert from RGB to BGR
...
#
#
# class Game_MountainCar(AbstractGame):
#     """
#     Game wrapper for Mountain Car.
#     """
#
#     def __init__(self):
#         # Create the discrete version of the Mountain Car environment
#         self.env = gym.make("MountainCar-v0", render_mode="rgb_array")
#
#         # Set up discrete actions
#         self.action_space = 3  # Actions: 0: push left, 1: do nothing, 2: push right
#
#     def step(self, action):
#         """
#         Apply action to the game.
...
#         observation_3d = np.array(
#             observation, dtype=np.float32).reshape(1, 1, -1)
#         return observation_3d, reward, terminated or truncated
#
#     def legal_actions(self) -> List[int]:
#         """
#         Return the legal actions at each turn.
#         For Mountain Car, all three actions are valid.
#
#         Returns:
#             An array of integers, subset of the action space.
#         """
#         return list(range(self.action_space))  # All actions are legal: [0, 1, 2]
#
#     def reset(self):
#         """
#         Reset the game for a new game.
...
#             2: "Push right",
#         }
#         return f"{action_number}. {actions.get(action_number, 'Unknown action')}"
#
#
# gym.register_envs(ale_py)
#
#
# class Game_TicTacToe3D(AbstractGame):
#     """
#     Game wrapper for Mountain Car.
#     """
#
#     def __init__(self):
#         # Create the discrete version of the Mountain Car environment
#         self.env = gym.make("ALE/TicTacToe3D-v5", render_mode='human')
#
#         # Set up discrete actions
#         self.action_space = 10  # Actions: 0: push left, 1: do nothing, 2: push right
#
#     def step(self, action):
#         """
#         Apply action to the game.
...
#         # print(type(observation));print((observation).shape);print((observation))
#         observation_3d = np.array(
