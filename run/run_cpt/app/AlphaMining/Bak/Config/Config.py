...
cfg:Any = munch.munchify(cfg_dict)

from Mining.Expression.Tokens import \
    NUM_OPERANDS, operand_tokens, NullToken, RegisterToken, null_token_idx, \
    NUM_OPERATORS, operator_tokens, UNARY_OP_TOKENS, BINARY_OP_TOKENS, TERNARY_OP_TOKENS, start_token_idx, finish_token_idx
from Mining.Config.Util import \
    initialize_UNARY_actions, initialize_BINARY_actions, initialize_TERNARY_actions
# call cfg.xxx.xxx.xxx directly

unary_actions,   unary_token_actions   = initialize_UNARY_actions(UNARY_OP_TOKENS, operand_tokens, null_token_idx)
binary_actions,  binary_token_actions  = initialize_BINARY_actions(BINARY_OP_TOKENS, operand_tokens, action_shift=len(UNARY_OP_TOKENS))
ternary_actions, ternary_token_actions = initialize_TERNARY_actions(TERNARY_OP_TOKENS, operand_tokens, action_shift=len(UNARY_OP_TOKENS) + len(BINARY_OP_TOKENS))
